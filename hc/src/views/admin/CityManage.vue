<template>
  <div>
    <el-button type="primary" @click="addPeople">新增城市</el-button>
    <br />
    <br />
    ...
    <el-drawer title="编辑" :visible.sync="drawer" direction="rtl" :before-close="handleClose">
      <el-form :model="editData">
        <el-form-item label="名称" label-width="80px">
          <el-input v-model="editData.name" autocomplete="off" placeholder="请输入名称"></el-input>
        </el-form-item>
        ...
        <el-form-item label="相关人物" label-width="80px">
          <el-dropdown :hideOnClick="false" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-checkbox-group v-model="peopleCheckList">
                <el-dropdown-item command="a">
                  <el-checkbox label="复选框A">hahah</el-checkbox>
                </el-dropdown-item>
                <el-dropdown-item command="a">
        ...
        <el-form-item label="相关事件" label-width="80px">
          <el-dropdown :hideOnClick="false" trigger="click">
            <span class="el-dropdown-link">
              请选择相关事件
              <i class="el-icon-arrow-down el-icon--right"></i>
